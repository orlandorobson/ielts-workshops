...
function render(){
 ...
 if(!serviceReady){create.disabled=true;status.textContent="Day 2 classroom activation is pending. The service needs its Day 2 registry configuration before classes can be created.";}
