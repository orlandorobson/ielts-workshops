...
function render(){
 ...
 if(!serviceReady){create.disabled=true;status.textContent="Day 3 classroom activation is pending. The service needs its Day 3 registry configuration before classes can be created.";}
